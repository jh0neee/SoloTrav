...
export const STARTER_PROMPTS: SuggestedPrompt[] = [
  ...
  {
    label: '혼자 떠나는 단양 1박 2일',
    prompt:
      '단양에서 1박 2일, 대중교통으로 무리 없이 야경까지 볼 수 있는 혼행 코스를 짜줘.',
  },
];
...
export const QUICK_PROMPTS: SuggestedPrompt[] = [
  {
    label: '근처 혼밥 장소',
    prompt: '지금 있는 곳 근처에서 혼자 밥 먹기 좋은 곳을 찾아줘.',
  },
  {
    label: '주변 안전시설',
    prompt: '지금 주변에 병원, 안심이 집, CCTV 같은 안전시설이 있는지 알려줘.',
  },
  {
    label: '혼자 가기 좋은 관광지',
    prompt: '혼자 가기 좋은 관광지를 추천해줘.',
  },
  {
    label: '지금부터 갈 만한 곳',
    prompt: '지금 시간부터 혼자 다녀올 만한 곳을 알려줘.',
  },
];
